@section('content')
  ...
  <p>Let's say your backend renders HTML views like this:</p>

  <script src="https://gist.github.com/GesJeremie/d30f05c65ad5af76a3f1.js"></script>

  <p>You can retrieve the form as a json like this:</p>
  ...
  <h2 id="exclude-datas"><a href="#exclude-datas" class="anchor">#</a> Exclude data fields</h2>

  <p>Sometimes you don't want to keep some data fields out of your JSON, you can use <em>exclude()</em>
